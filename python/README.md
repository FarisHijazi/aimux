...
```bash
uvx --from git+https://github.com/FarisHijazi/aimux#subdirectory=python uzi --help
```
...
alias uzi='uvx --from git+https://github.com/FarisHijazi/aimux#subdirectory=python uzi'
```
...
> **Note:**
> - If using uvx from GitHub: `uvx --from git+https://github.com/FarisHijazi/aimux#subdirectory=python uzi <command>`
