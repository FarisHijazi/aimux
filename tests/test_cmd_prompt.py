...
class TestPortAvailability:
    ...
    def test_is_port_available_true(self, mock_socket):
        ...
        result = prompt.is_port_available(3000)
...
class TestAgentParsing:
    ...
    def test_parse_agents_single(self):
        ...
        result = prompt.parse_agents("claude:1")
    ...
    def test_parse_agents_multiple(self):
        ...
        result = prompt.parse_agents("claude:2,codex:3")
        assert len(result) == 2
...
class TestExecutePrompt:
    ...
    def test_execute_prompt_multiple_agents(
        ...
        prompt.execute_prompt("Test prompt", "claude:3")
...
class TestCloneRepository:
    ...
    def test_clone_repository_success(self, mock_run):
        ...
        result = prompt.clone_repository("https://github.com/test/repo.git", target_dir)
...
class TestCopyDirectory:
    ...
    def test_copy_directory_recursive_success(self, temp_dir):
        ...
        result = prompt.copy_directory_recursive(source, dest)
...
class TestExecutePromptWithOptions:
    ...
    def test_execute_prompt_no_worktree(
        ...
        prompt.execute_prompt("Test prompt", "claude:1", no_worktree=True)
