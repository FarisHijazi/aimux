...
class TestCLIMain:
    ...
    @patch("uzi.cli.prompt.execute_prompt")
    ...
    @patch("uzi.cli.kill.execute_kill")
    ...
    @patch("uzi.cli.auto.execute_auto")
    ...
    @patch("uzi.cli.broadcast.execute_broadcast")
    ...
    @patch("uzi.cli.checkpoint.execute_checkpoint")
    ...
    @patch("uzi.cli.reset.execute_reset")
    ...
    @patch("uzi.cli.ls.execute_ls", side_effect=Exception("Test error"))
