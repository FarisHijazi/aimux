...
from uzi.cmd import ls


class TestGitDiffTotals:
    """Test git diff statistics."""

    @patch("uzi.cmd.ls.subprocess.run")
    @patch("uzi.cmd.ls.StateManager")
...
class TestAgentStatus:
    ...
    @patch("uzi.cmd.ls.get_pane_content")
...
class TestExecuteLs:
    ...
    @patch("uzi.cmd.ls.get_agent_status", return_value="ready")
    @patch("uzi.cmd.ls.get_git_diff_totals", return_value=(10, 5))
    @patch("uzi.cmd.ls.StateManager")
